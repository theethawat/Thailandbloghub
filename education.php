...
<div class="row">
  ...
  $sql="SELECT * FROM 00education ORDER BY ID DESC ";
      ...
      for($i=$ini;$i<$fin;$i++)
      {
         ...
         if($row!=NULL)
         {
            ...
            else
            {
                //regular part
                print "<div class='photodiv'>";
                print "<img class='card-img-top' src='education/".$row["photo"]."'>";
                print "</div>";
            }
            ...
            {   
                print "<form style='text-align:center;'action='like.php' method='post'><input hidden name='catagory'value='00education'><button type='submit' class='btn btn-warning' name='idoflike' value='$idoflist'><i class='fas fa-heart'></i> Like ".$like."</button></form>";
            }
            if($recievedatarow!=NULL)
            {
