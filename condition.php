...
<br>
<div class="container">
<h4 class="kanit">ข้อกำหนดและเงื่อนไขการใช้งาน</h4>
<div class="row">
  ...
  <h5 class="kanit">ข้อกำหนดในการโพสต์</h5>
  <p>
      <li>ไม่เป็นบทความที่เป็นการหมิ่นพระบรมเดชานุภาพ หรือ พูดในด้านที่ไม่สมควรกับสถาบันพระมหากษัตริย์ของไทย</li>
      <li>ไม่เป็นบทความที่สร้างความขัดแย้ง ยุยงปลุกปั่น หรือ มีผลต่อความมั่นคงของประเทศ</li>
      <li>ไม่เป็นบทความที่ให้ร้าย หรือ หมิ่นประมาทผู้อื่นโดยไม่มีเหตุผล หรือสร้างความแตกแยกในสังคม และไม่ใช่ถ้อยคำเสียดสี หยาบคาย</li>
      <li>ไม่เป็นบทความเกี่ยวกับสิ่งที่เป็นเรื่องลามก อนาจาร และไม่นำภาพลามกอนาจาร หรือ ภาพที่เป็นเหตุร้ายแรงจากสงคราม หรือภาพที่ไม่สมควรอื่นๆ มาเป็นภาพของโพสต์นั้น </li>
      <li>ไม่เป็นเว็บไซต์ หรือ บทความที่เป็นการโฆษณาของสิ่งเสพติด หรือ การพนัน</li>
      <li>หากการกระทำใดที่ขัดกับข้อกำหนดที่ผ่านมา ผู้ดูแลเว็บไซต์มิสิทธิในการลบโพสต์ของท่านออกจากเว็บไซต์ไทยแลนด์บล็อกฮับ รวมถึงมีสิทธิที่จะเตือนท่านผ่านอีเมลที่ท่านให้ไว้</li>
    </p>
