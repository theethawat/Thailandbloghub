...
<img src="logo_tbh.png" width="30" height="30" alt="">
 ...
 // $_SESSION["user"]=NULL;
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    ...
    <a class="nav-item nav-link active" href="science.php">Science <span class="sr-only">(current)</span></a>
...
<div class="row">
  ...
  $sql="SELECT * FROM 00science ORDER BY ID DESC ";
      ...
      for($i=$ini;$i<$fin;$i++)
      {
         ...
         if($row!=NULL)
         {
            ...
            else
            {
                //regular part
                print "<div class='photodiv'>";
                print "<img class='card-img-top' src='science/".$row["photo"]."'>";
                print "</div>";
            }
            ...
            {   
                print "<form style='text-align:center;'action='like.php' method='post'><input hidden name='catagory'value='00science'><button type='submit' class='btn btn-warning' name='idoflike' value='$idoflist'><i class='fas fa-heart'></i> Like ".$like."</button></form>";
            }
            if($recievedatarow!=NULL)
            {
