...
<img src="logo_tbh.png" width="30" height="30" alt="">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    ...
    <a class="nav-item nav-link " href="science.php">Science <span class="sr-only">(current)</span></a>
      ...
      <a class="nav-item nav-link active" href="entertainment.php">Entertainment</a>
...
<br>
<div class="container">
<h3 class="kanit">Entertainment</h3>
<div class="row">
  <div class="col">
  <!-- PHP Code zone -->
  <?php
  ...
  $sql="SELECT * FROM 00entertainment ORDER BY ID DESC ";
      ...
      for($i=$ini;$i<$fin;$i++)
      {
         ...
         if($row!=NULL)
         {
            ...
            else
            {
                //regular part
                print "<div class='photodiv'>";
                print "<img class='card-img-top' src='entertainment/".$row["photo"]."'>";
                print "</div>";
            }
            ...
            {   
                print "<form style='text-align:center;'action='like.php' method='post'><input hidden name='catagory'value='00entertainment'><button type='submit' class='btn btn-warning' name='idoflike' value='$idoflist'><i class='fas fa-heart'></i> Like ".$like."</button></form>";
            }
            if($recievedatarow!=NULL)
            {
